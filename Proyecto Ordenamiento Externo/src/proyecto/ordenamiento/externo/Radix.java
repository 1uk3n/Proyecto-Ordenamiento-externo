...
/**
 * Clase Radix, no modela ningún tipo de dato abstracto en específico.
...
public class Radix{
    ...
    System.out.println(iteraciones.toPath().getParent().toString() + File.separatorChar + "Radix Terminado -" + nombreCarpeta.substring(8) + ".txt");
